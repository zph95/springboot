...
public final class BigDecimalUtil {
    ...
    private static final long ITER = 1000;
    public static MathContext context = new MathContext(100);
    public static BigDecimal PI_DIV_180
            = new BigDecimal("3.1415926535897932384626433832795").divide(BigDecimal.valueOf(180), 32, RoundingMode.HALF_UP);
    public static BigDecimal PI_DIV_200
            = new BigDecimal("3.1415926535897932384626433832795").divide(BigDecimal.valueOf(200), 32, RoundingMode.HALF_UP);
    ...
    public static BigDecimal cosine(BigDecimal x) {
        ...
        while (lastVal.compareTo(currentValue) != 0) {
            ...
            denominator = denominator.multiply(BigDecimal.valueOf(z).subtract(BigDecimal.ONE));
